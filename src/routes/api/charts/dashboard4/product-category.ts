...
export const APIRoute = createAPIFileRoute('/api/charts/dashboard4/product-category')({
  GET: async ({ request }) => {
    console.info('Fetching Dashboard4 product category chart data... @', request.url)
